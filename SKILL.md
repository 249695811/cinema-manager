---
name: cinema-manager
description: Search movie/TV resources across sites, save to Quark cloud drive, auto-organize library for Infuse/Plex. Plugin system for custom resource sites. Use when user wants to find/watch movies, save to cloud drive, or manage media library.
---

# Cinema Manager

Movie/TV search → Quark save → Library organization.
...
- `plugins` — enable/disable resource site plugins
...
2. `cinema.py search` across all plugins
3. Score results, pick best quark version
